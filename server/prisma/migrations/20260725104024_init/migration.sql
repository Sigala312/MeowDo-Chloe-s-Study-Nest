...
CREATE TABLE `PomodoroLog` (
    ...
    `expEarned` INTEGER NOT NULL DEFAULT 10,
...
-- AddForeignKey
ALTER TABLE `WheelDrawLog` ADD CONSTRAINT `WheelDrawLog_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `User`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `WheelDrawLog` ADD CONSTRAINT `WheelDrawLog_rewardId_fkey` FOREIGN KEY (`rewardId`) REFERENCES `WheelReward`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
